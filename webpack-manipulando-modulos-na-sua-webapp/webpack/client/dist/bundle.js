...
throw new Error("Module parse failed: /home/geninho/documents/repositories/alura-workspace/webpack-manipulando-modulos-na-sua-webapp/webpack/client/app-src/controllers/NegociacaoController.js Unexpected character '@' (5:0)\nYou may need an appropriate loader to handle this file type.\n| import { getNegociacaoDao, Bind, getExceptionMessage, debounce, controller, bindEvent } from '../util/index.js';\n| \n| @controller('#data', '#quantidade', '#valor')\n| export class NegociacaoController {\n| ");
